...
| [<img src=".github/github.png" align="top" width="20" />](https://github.com/clangen/musikcube) | `musikcube` | <i>a cross-platform, terminal-based audio engine, library, player and server written in c++.</i> |
